...
- [Programmatic macros and type-safe catalog builders](macros_and_typesafe_builders.md): Comprehensive proposal detailing the concept of macros, code generation architecture via Dart CLI (`dart/a2ui_cli`), Python fluent builder API, catalog JSON ingestion in `@a2ui/web_core`, and the macro runtime engine.
